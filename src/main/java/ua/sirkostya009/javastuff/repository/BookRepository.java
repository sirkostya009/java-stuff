...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Modifying
    @Query("update Book b set b.author = :newAuthor where b.id = :id")
    void updateBookAuthor(Long id, String newAuthor);
    ...
    @Modifying
    @Query("update Book b set b.genre = :newGenre where b.id = :id")
    void updateBookGenre(Long id, Genre newGenre);
}
